      ...
      children: [
        {
          ...
          type: "Equipment",
          parameters: [
            { name: "额定容量", value: 50000, unit: "kVA", source: "表 T-201" },
            { name: "额定电压", value: 110, unit: "kV", source: "表 T-201" }
          ],
          children: []
        },
        {
      ...
      children: [
        {
          ...
          type: "Equipment",
          parameters: [
            { name: "流量", value: 1200, unit: "m3/h", source: "表 P-101" },
            { name: "功率", value: 250, unit: "kW", source: "表 P-101" },
...
export const parameters = [
  { id: 1, equipmentId: "equ-transformer", equipmentName: "主变压器", paramName: "额定容量", value: 50000, unit: "kVA", source: "表 T-201" },
  { id: 2, equipmentId: "equ-transformer", equipmentName: "主变压器", paramName: "额定电压", value: 110, unit: "kV", source: "表 T-201" },
  { id: 3, equipmentId: "equ-pump", equipmentName: "循环水泵", paramName: "流量", value: 1200, unit: "m3/h", source: "表 P-101" },
